        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="card-header">
                    <h2>Conoce a los líderes de tu colegio</h2>
                    <div class="clearfix"></div>
                </div>
                <div>
                    <p>Desglose de la Dirección de Gestión de Colegios</p>
                </div>
                <!--Inicio arbol-->
                <div id="wrapper">
                <div id="container">
                                ...
                                <li v-for="volunteer in organization.children">
                                    ...
                                    <ol v-if="volunteer.childrenFlag == true">
                                        <li v-for="volunteer2 in volunteer.children">
                                            ...
                                            <ol v-if="volunteer2.childrenFlag == true">
                                                <li v-for="volunteer3 in volunteer2.children">
                                                    <div class="cardPerson-wrapper">
                                                        <div class="cardPerson">
                                                            <a class="cardPerson-link" :href="volunteer3.url" target="_blank">
                                                                <div class="cardPerson-information-img-wrapper"><img class="cardPerson-information-img" :src="volunteer3.img" width="100" height="100"></div>
                                                                <div class="cardPerson-information-wrapper">
                                                                    <div class="cardPerson-information-name">{{volunteer3.name}}</div>
                                                                    <div class="cardPerson-information-title">{{volunteer3.title}}</div>
                                                                </div>
                                                            </a>
                                                        </div>
                                                    </div>
    ...
    export default {
        ...
        methods: {
                            ...
                            aux2.childrenFlag = false;
                             if(volunteer2.childen.length !=0) {
                                 ...
                                 _.map(volunteer2.childen,(volunteer3)=>{
                                     ...
                                     if(volunteer3.childen.length !=0) {
                                         aux3.childrenFlag = true;
                                         aux3.children = [],
                                         _.map(volunteer3.childen,(volunteer4)=>{
                                             var aux4 = {};
                                             aux4.title = volunteer4.name;
                                             if(volunteer4.VolunteerJobs.length == 0) {
                                                aux4.name = "Vacante";
                                                aux4.img = "./user.png";
                                                aux4.url = null;
                                                aux3.children.push(aux4);
                                            } else {
                                                _.map(volunteer4.VolunteerJobs,(volunteerAux)=>{
                                                    aux4.name = (volunteerAux.Volunteer.name != null ? volunteerAux.Volunteer.name : "") + (volunteerAux.Volunteer.lastName != null ? " " + volunteerAux.Volunteer.lastName : "");
                                                    aux4.img = (volunteerAux.Volunteer.imageUrl != null ? volunteerAux.Volunteer.imageUrl : "./user.png");
                                                    aux4.url = (volunteerAux.Volunteer.websiteUrl != null ? volunteerAux.Volunteer.websiteUrl : null);
                                                    aux3.children.push(aux4);
                                                });
                                            }
                                         });
            ...
            async createHierarchy() {
                this.isLoading=true;
                var tempSchool = this.school.AssignmentRecords[0].School;
                //Cambiar el servicio
                const response = await consultServices('getSchoolTree','POST', {id: tempSchool.id, semesterCode: this.semester.id });
