    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      ...
      <div class="card">
            <div class="card-header">
                <h1>Contenido pedagógico de talleres - Semestre {{semester.displayName}}</h1>
                <div class="clearfix"></div>
                <h2> Aquí podrás colocar el contenido pedagógico para la ruta de los talleres multidisciplinarios</h2>
                <!-- <h2 style="color:#f86c6b">Solo se pueden cargar en formato word: .docx</h2> -->
            </div>

            <div class="card-body">
              <form class="form-horizontal" action="" method="post">
                <div class="card-body">
                  <TableMaf :header="colum" :data="classes" :tableTitle="titleTable" ref="tableMaf"></TableMaf>
                </div>
              </form>
            </div>
      ...
      methods: {
        ...
        async listSilabus() {
         ...
         async updateClass() {
           if(!this.formEdit.content ){
               alert("Debe completar el contenido de la clase");
           }
           else{
           ...
           var flag = confirm("¿Guardar cambios");
            if(flag == true){
                ...
                form.urlMathContent = this.formEdit.urlMathContent;
        ...
        setHeadTable(){
            this.colum = [
                ...
                //{label:'Guía' ,name:'guide' ,find:1 ,sort:1},
        ...
        download(){
          var downloadUrl = "http://drive.google.com/uc?export=view&id=1ym_jFdOAz0R6GHfTUjDQYMrhujMfYZRDdumYoFoQRHs";
        ...
        setDataTable(arrayData){
                ...
                arrayData.forEach(item => {
                    var classItem = {};
                        ...
                        /*classItem.guide = <div class="d-flex justify-content-around">
                           <div> Guía de prueba <button onClick={()=>ctx.download()} type="button" class="btn btn-success btn-xs"><i class="fa fa-download"></i> </button> </div>
                            {/*
                            <a href="https://drive.google.com/uc?id=1ym_jFdOAz0R6GHfTUjDQYMrhujMfYZRDdumYoFoQRHs&export=download&authuser=0" target="_blank"> prueba guía 1.0</a>
                            <a id='word' href='https://drive.google.com/uc?id=1ym_jFdOAz0R6GHfTUjDQYMrhujMfYZRDdumYoFoQRHs&export=download&authuser=0' download='prueba.docx' > Prueba guía 2.0</a>
                            }
                           </div>;*/
                        classItem.actions=<div class="d-flex justify-content-around">
                           <div> <button onClick={()=>ctx.showEdit(item)}   type="button" class="btn btn-success btn-xs"data-target=".bs-example-modal-lg" data-toggle="modal">Actualizar contenido</button> </div>
                           </div>;
