    ...
    export default {
        ...
        methods: {
            ...
            generatePDF(){
                ...
                var imgData = 'https://creamas-space.sfo2.digitaloceanspaces.com/anniversary/assets/CertificadoRepotenciadores.png'        
                ...
                //Agregar imagen de fondo en el documento
                if(this.volunteer.roleParticipation == 'TEAM_CAPTAIN'){
                    //usar el certificado para capitanes
                    imgData = 'https://creamas-space.sfo2.cdn.digitaloceanspaces.com/anniversary/assets/image.png'
                }
